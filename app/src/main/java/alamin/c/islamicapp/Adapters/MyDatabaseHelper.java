...
public class MyDatabaseHelper extends SQLiteOpenHelper {
        ...
        private  static  final  String DATABASE_NAME="Choice.db";
        private  static  final  String TABLE_NAME="choice";
        private  static  final  String CHOICE_TABLE_NAME="ChoiceDataList";
        ...
        private  Context context;
         ...
         private  static  final  String GETVALUE2="SELECT * FROM "+CHOICE_TABLE_NAME;
