...
public class LikeAdapters extends RecyclerView.Adapter<LikeAdapters.MyViewHolder> {


    private OnItemClickListner listner;
    private Context context;
    private List<ChoiceData> choiceData;

    public LikeAdapters(Context context, List<ChoiceData> choiceData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        ChoiceData lastRead=choiceData.get(position);
